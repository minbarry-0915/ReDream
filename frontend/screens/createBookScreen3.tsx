      ...
      <ScrollView
        ...
        <View
          style={[
            ...
            {
              justifyContent: errorMessege ? 'space-between' : 'flex-end',
              flexDirection: 'row',
            },
          ]}>
          {errorMessege ? (
            <Text style={[GlobalStyles.lightText, {color: '#E93B3B'}]}>
              글자 수가 초과되었습니다.
            </Text>
          ) : null}
          <View style={{flexDirection: 'row'}}>
            <Text style={[GlobalStyles.lightText, {color: 'black'}]}>
