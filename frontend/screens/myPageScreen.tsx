...
import { KeyboardAvoidingView, ScrollView, View, Text, TouchableOpacity, Modal, Alert } from "react-native";
            ...
            >
                ...
                <View style={[GlobalStyles.content,
                     {  justifyContent: 'flex-start',
                        alignItems: 'baseline',
                        flexDirection: 'row'}]}>
                    <Text style={[GlobalStyles.semiBoldText,{fontSize: 26, color: '#3B73E8'}]}>{userId}</Text>
                ...
                <View style={GlobalStyles.content}>
                    ...
                    <TouchableOpacity 
                        ...
                        style={MyPageStyles.container}
                    >
                        <Text style={[GlobalStyles.mediumText, { color: '#E93B3B' }]}>로그아웃</Text>
                    </TouchableOpacity>
                </View>
            </ScrollView>
                ...
                >
                    <View style={GlobalStyles.messegeModalContainer}>
                        <View style={GlobalStyles.messegeModalContent}>
                            <Text style={[GlobalStyles.semiBoldText, { fontSize: 16 }]}>탈퇴하시겠습니까?</Text>
