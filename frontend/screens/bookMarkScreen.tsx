      ...
      deleteBook(selectedBookId)
        .then(() => {
          setBookList(prevList =>
            prevList.filter(book => book.bookId !== selectedBookId),
          );
      ...
      <ScrollView
        ...
        <View style={HomeScreenStyles.content}>
          <View style={HomeScreenStyles.bookListHeaderContainer}>
            <Text style={[GlobalStyles.semiBoldText, {fontSize: 18}]}>
              저장된 동화 목록
            </Text>
            {editMode ? (
              <TouchableOpacity
                ...
                <Text
                  style={[
                    ...
                    {fontSize: 18, color: '#E93B3B', marginRight: 8},
                  ]}>
                  완료
                </Text>
              ...
              <TouchableOpacity
                ...
                <Text
                  style={[
                    GlobalStyles.mediumText,
                    {fontSize: 18, color: '#3C3C3C', marginRight: 8},
                  ]}>
                  편집
                </Text>
          ...
          <View style={GlobalStyles.messegeModalContent}>
            {loading ? (
              <>
                ...
                <Loading
                  style={[AnimationStyles.loading, {width: 100, height: 100}]}
                />
